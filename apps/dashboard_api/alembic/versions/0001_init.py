...
def upgrade() -> None:
    ticket_status = sa.Enum('PENDING_APPROVAL', 'APPROVED', 'REJECTED', 'QUEUED', 'RUNNING', 'DONE', 'FAILED', name='ticketstatus')
    ticket_priority = sa.Enum('P0', 'P1', 'P2', 'P3', name='ticketpriority')
    run_status = sa.Enum('RUNNING', 'DONE', 'FAILED', name='runstatus')
